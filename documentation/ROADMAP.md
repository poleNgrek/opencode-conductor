...
- **Status:** Implemented and graduated into `[Unreleased]` in `CHANGELOG.md`.
- **What shipped:** Docusaurus-friendly docs entry (`docusaurus/intro.md`), architecture section with 10 pages and mermaid diagrams, plus new categorized sections for workflows, commands, contributing/testing, skills, and knowledge.
...
- **Docs shipped:** workflow, command matrix, test-plan coverage, and Docusaurus section at `docusaurus/help-docs-authoring/`.
